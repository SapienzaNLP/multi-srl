...
# python3 srl/train.py --name bert-multilingual-en-ft --language_model_fine_tuning --language_model_learning_rate 1e-5 --language_model_min_learning_rate 1e-9 --batch_size 8 --accumulate_grad_batches 16
